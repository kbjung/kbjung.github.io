...
{:toc}
    ...
    The width of the display has to be larger than 1665px for the ToC to become sticky. </br>
    Otherwise, the ToC will appear where the seed list is placed in the document. </br>
...
{% include components/youtubePlayer.html id='uz394aKhfLY' %}
...
<div class="main_center">
    ...
    <div><img src="/assets/img/blog/example1/2.jpg" style="width: auto; height: 500px;"></div>
    <div><img src= "/assets/img/blog/example1/3.jpg" style="width: auto; height: 500px;"></div>
</div>
<script>
